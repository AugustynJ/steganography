...
if __name__ == "__main__":
    ...
    SPECIAL_CLIENT_IP = args.client
    BITS_FILE = args.bits_file
    RESOLVER_FILE = args.resolver_file
    FORWARDER = args.forwarder
    SERVER_IP = "0.0.0.0"
    SECRET_DOMAIN = args.secret_domain

    # Wczytywanie słownika {domena: ip}
    global resolver_dict
    resolver_dict = load_resolver_file(RESOLVER_FILE)

    start_server(PORT, SPECIAL_CLIENT_IP, FORWARDER, BITS_FILE)
